...
MODULE Constants
  ...
  INTEGER , PARAMETER :: ndavl = 246 ! Number of Available Diagnostics Fields
  ...
  INTEGER , PARAMETER :: ngfld=90 ! Number of Available Grid History Fields

  ! Dimension for Units Arrays
  INTEGER , PARAMETER :: nunits = 260        ! Number of Defined Units
  INTEGER , PARAMETER :: numx   = nunits-1   ! Number of Defined Units minus 1
  ...
  ! temperature (k)
  REAL (KIND=r8), PARAMETER   :: qmin  =                 1.0e-21_r8! minimum value relative humidity relhum
  ...
  REAL (KIND=r8), PARAMETER   :: Cts_pref   =            101300.e0_r8! Reference pressure at sea level (Pa)
