...
!new 2012
    ...
    DO i=1,nCols
       ...
       cine(i)=0.0_r8
       !ps(i)=prsi(i,1)/1000.0_r8          !convert Pa to cbar
       psur (i) = prsi(i,1)/100.0_r8 !convert Pa to mbar
    END DO
    DO k=1,kMax
      DO i=1,nCols
          dtdt (i,k)=0.0_r8
    ...
    DO k = 1, kMax
       DO i = 1,nCols
          ...
          po  (i,k) = prsl(i,k)/100.0_r8! conver Pa to mbar
          p   (i,k) = po(i,k)
          us  (i,k) = ua(i,k) 
          vs  (i,k) = va(i,k) 
