...
_nomeb='/scratchout/oper/tempo/BAM/pos/dataout/TQ0666L064/2016102000/Preffix'%_labeli%_labelf%'.'%_trlv

* nomes dos arquivos com identificacao e local dos pontos
_nomec='/scratchout/oper/tempo/BAM/pos/dataout/TQ0666L064/2016102000/Identif'%_labeli%_labelf%'.'%_trlv
_nomed='/scratchout/oper/tempo/BAM/pos/dataout/TQ0666L064/2016102000/Localiz'%_labeli%_labelf%'.'%_trlv
nomectl ='/scratchout/oper/tempo/BAM/pos/dataout/TQ0666L064/2016102000/'%_nomea%_labeli%_labelf%'M.grh.'%_trlv%'.ctl'
*say nomectl
...
say 'printim /scratchout/oper/tempo/BAM/grh/dataout/TQ0666L064/2016102000/'lab'.png png'
'printim /scratchout/oper/tempo/BAM/grh/dataout/TQ0666L064/2016102000/'lab'.png png' 
'!rm -f meteogram'
if (_loc=1)
