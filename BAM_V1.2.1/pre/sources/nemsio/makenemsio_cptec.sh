...
mkdir -p NCEPLIBS-nemsio-2.5.4/build
cd NCEPLIBS-nemsio-2.5.4/build
CC=${CC} FC=${FC} cmake -DCMAKE_INSTALL_PREFIX=../../NCEPLIBS-nemsio-2.5.4/rls -DCMAKE_PREFIX_PATH="../../bacio/NCEPLIBS-bacio-2.5.0/rls;../../w3emc/NCEPLIBS-w3emc-2.9.3/rls" ..
make -j2
make install
